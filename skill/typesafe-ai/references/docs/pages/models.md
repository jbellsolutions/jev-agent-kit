...
See the [Python](sdk/python/api/clients/sync/models.md) and [JavaScript](sdk/javascript/api/interfaces/Models.md) SDK references for the full method signatures.
