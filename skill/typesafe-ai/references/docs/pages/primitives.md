...
<Columns cols={3}>
  <Card title="Choice" href="primitives/choice.md" icon="list">
    Pick one option from a fixed list.
  </Card>

  <Card title="Score" href="primitives/score.md" icon="gauge">
    Rate the state along ordered levels.
  </Card>

  <Card title="Noul" href="primitives/noul.md" icon="circle-check">
