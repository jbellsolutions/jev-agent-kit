...
For "Is the candidate strong in Python?", define what "strong" means. An unclear definition makes the probability hard to interpret. A value of 0.5 does not mean medium skill. Use a [Score](score.md) to measure skill along defined levels. [Choose a question type](../primitives.md#choose-a-question-type) explains the distinction.
